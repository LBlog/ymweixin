      ...
      <!--   <input type="hidden" name="pid" id="pid" value=""/> -->
       ...
       <tr> 
        ...
        <TR>
          <TH >活动起止时间：</TH>
          <TD>
     		     开始日：<input class="laydate-icon" id="start" style="width:200px; margin-right:10px;"></input>
			     结束日：<input class="laydate-icon" id="end" style="width:200px;"></input>
          </TD>
       </TR>
...
$(document).ready(function(){
	...
	$.post('index.php?g=User&m=Apispread&a=save_spread', data, function(response){
