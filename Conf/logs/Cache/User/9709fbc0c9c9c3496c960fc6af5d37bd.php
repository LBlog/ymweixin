     ...
     <table class="userinfoArea" style=" margin:0;" border="0"  cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        ...
        <input type="text" name="title" id="title" value="<?php echo ($item["title"]); ?>" class="px" style="width:400px;" />
        </td> 
       </tr> 
        ...
        <input type="text" name="point" id="point" value="<?php echo ($item["point"]); ?>" class="px" style="width:200px;"  onkeyup='this.value=this.value.replace(/^0|\D/gi,"")' />
        </td> 
       </tr> 
      
       <tr> 
        <th>排序：</th> 
        <td><input type="text" id="score" name="score" value="<?php echo ($item["score"]); ?>" class="px" style="width:50px;" onkeyup='this.value=this.value.replace(/^0|\D/gi,"")'  />  数字越小排再越前（大于等于0的整数）</td> 
       </tr>
        ...
        <TR>
          <TH >活动起止时间：</TH>
          <TD>
     		     开始日：<input class="laydate-icon" id="start" value="<?php echo ($item["start"]); ?>" style="width:200px; margin-right:10px;"></input>
			     结束日：<input class="laydate-icon" id="end" value="<?php echo ($item["end"]); ?>" style="width:200px;"></input>
          </TD>
       </TR>
       
       <TR>
          <TH valign="top"><label for="info">营销详细：</label></TH>
          <TD><textarea name="content" id="intro" rows="5" style="width:590px;height:360px"><?php echo ($item["content"]); ?></textarea></TD>
       </TR>
		...
		<TR>
          ...
          <TD>
         	<select name="is_perment" id="is_perment" >
         		<option value="0">--请选择二维码类型--</option> 
         		<option value="1" <?php if(($item["is_perment"] == 1 )): ?>selected="selected"<?php endif; ?> > 永久二维码</option>
         		<option value="2"  <?php if(($item["is_perment"] == 2 )): ?>selected="selected"<?php endif; ?>  >临时二维码</option> 
         	</select>
          </TD>
       </TR>
...
$(document).ready(function(){
	...
	$.post('index.php?g=User&m=Apispread&a=edit_spread', data, function(response){
		if (response.error_code == false) {
			art.dialog({
			    ...
			    ok: function () {
			    	this.time(3);
			    	location.href="index.php?g=User&m=Apispread&a=spreadlist&token=<?php echo ($token); ?>";
			        return false;
			    },
			    cancelVal: '关闭'
			});
