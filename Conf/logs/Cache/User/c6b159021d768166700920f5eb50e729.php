...
<td>
<input type="text" class="px" name="name" placeholder="活动名称"/>
</td>
<tr>
...
<td>
<div id="img_div"><img src="../wx/images/default.jpg" style="max-height:100px; margin-bottom:0.5rem;"/></div>
<input type="button" class="file" onclick="upImage('img','1');" value="上传图片" style="padding:5px 10px;border:none;background:#428BCA;color:#fff;"/>
...
<td>
<input type="text" class="jcDate" id="start_time" name="start_time" readonly="readonly" placeholder="开始时间" value="" style="border:1px solid #ccc;padding:3px 5px;"/>
 - <input type="text" class="jcDate" id="end_time" name="end_time" readonly="readonly" placeholder="结束时间" value="" style="border:1px solid #ccc;padding:3px 5px;"/>		
</td>
<tr>

<tr>
<th width="200">活动地点：</th>
<td>
<input type="text" class="px" name="act_addr" placeholder="活动地点"/><span style="margin-left:10px;color:red;">请填写详细地址</span>
</td>
<tr>
...
<td>
<select class="form-control" id="act_type" name="act_type"><?php echo ($list); ?></select>
</td>
<tr>
...
<td>
<input type="text" class="px" name="people_num" placeholder="活动人数"/>
</td>
<tr>

<tr>
<th width="200">活动详情：</th>
<td>
<textarea id="editor" name="act_detail" type="text/plain" style="width:800px;height:300px;"></textarea>
</td>
<tr>

<tr>
<th width="200">可获积分数：</th>
<td>
<input type="text" class="px" name="act_point" placeholder="可获积分数"/> 分
</td>
</tr>
