        ...
        <div class="msgWrap bgfc"> 
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
                <tbody> 
                    <tr> 
                        <th>排序：</th> 
                        <td><input type="text" id="score" name="score" value="<?php echo ($item["score"]); ?>" class="px" style="width:50px;" />  数字越小排再越前（大于等于0的整数）</td> 
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                        ...
                        <td>
                            <!-- <input type="hidden" name="pid" id="pid" value=""/> -->
                            <input type="text" name="tel" id="tel" value="<?php echo ($item["tel"]); ?>" class="px" style="width:200px;" />
                        </td> 
                    </tr> 
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-3"> 
                                ...
                                <div id="pimg_div">
                                    <?php if($item['images']) {foreach ($item['images'] as $kd=>$vd){?>
                                    <img src="<?php echo $vd?>" style="max-height:100px; margin-bottom:0.5rem;"/>
                                    <?php }}?>
                                </div> 
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="address" name="address" value="<?php echo ($item["addr"]); ?>" class="px" style="width:200px;" /> <a href="javascript:void(0)" class="btnGray" onclick="searchSom(this)">搜索</a><br>
                        </td>
                    </tr>
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">兑换点经纬度：</label></th>
                        <td>
                            <input type="text" id="coordinate" name="coordinate" value="<?php echo ($item["position"]); ?>" class="px" style="width:200px;" readonly />
                        </td>
                    </tr>
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">所属区域：</label></th>
                        <td>
                            <input type="text" id="areas" name="areas" value="<?php echo ($item["city"]); ?>" class="px" style="width:200px;" readonly />
                        </td>
                    </tr>
                    <tr>
...
<script>
    ...
    var init = function () {
        var center = new qq.maps.LatLng(<?php echo ($item["position"]); ?>);
...
//                $("#position").val(result.detail.location);
    ...
    function addApiext() {
        ...
        $.post('index.php?g=User&m=Apiext&a=edit_ext', data, function (response) {
...
<script type="text/javascript">
    ...
    ue.addListener("ready", function () {
                // editor准备好之后才可以使用
                ue.setContent('<?php echo ($item["content"]); ?>');
            });
    //实例化编辑器
