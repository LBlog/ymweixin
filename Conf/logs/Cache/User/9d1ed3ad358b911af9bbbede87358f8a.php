...
<?php $__FOR_START_604168804__=1;$__FOR_END_604168804__=12;for($i=$__FOR_START_604168804__;$i < $__FOR_END_604168804__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择设备：
...
<?php $__FOR_START_87285568__=1;$__FOR_END_87285568__=12;for($i=$__FOR_START_87285568__;$i < $__FOR_END_87285568__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择页面：
