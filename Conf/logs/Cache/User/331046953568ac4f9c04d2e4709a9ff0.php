...
<!-- <ul id="tags">
  <li><a href="<?php echo U('Api/add_grade',array('token'=>$token));?>">添加等级</a> </li>
...
关键词：
<input type="text" class="px" name="search" value="<?php echo ($search); ?>" style="height:25px;width:150px;" placeholder="真姓名或者手机号">
...
<div class="msgWrap">
<form method="post"  action="" id="info" >
<input type="hidden" name="token" value="<?php echo ($token); ?>" id="mb_id">
<TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
<THEAD>
<tr>
<th width="120" style="text-align:center">会员id</th>
<th width="120" style="text-align:center">微信昵称</th>
<th width="120" style="text-align:center">微信头像</th>
<th width="120" style="text-align:center">会员姓名</th>
<th width="120" style="text-align:center">会员手机号</th>
<th width="120" style="text-align:center">性别</th>
<th width="120" style="text-align:center">等级</th>
<th width="120" style="text-align:center">积分</th>
<th width="120" style="text-align:center">车牌</th>
<th width="120" style="text-align:center">注册归属地</th>
<th width="120" style="text-align:center">推荐用户名称</th>
<th width="100" style="text-align:center">操作</th>
</tr>
</THEAD>
<TBODY>
<TR></TR>
<?php if(is_array($user_info)): $i = 0; $__LIST__ = $user_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><TR>
<TD style="text-align:center"><?php echo ($item["id"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["wechaname"]); ?></TD>
<TD style="text-align:center"><img src="<?php echo ($item["portrait"]); ?>" style="max-height:50px;"/></TD>
<TD style="text-align:center"><?php echo ($item["truename"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["tel"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["sex"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["rank"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["intergal"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["car_num"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["province"]); echo ($item["city"]); echo ($item["district"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["tname"]); ?></TD>
<TD style="text-align:center"> <a href=<?php U('Apiuser/edit');?>"?g=User&m=Apiuser&a=edit&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">编辑</a>
<a href="javascript:void(0)" onclick="del(this,<?php echo ($item["id"]); ?>)">删除</a></TD>
  ...
  if(confirm("确定删除这个记录？"))
    {
        ...
        $.ajax({
        type:"post",
        url:<?php U('Api/ajaxuserinfo');?>"?g=User&m=Api&a=ajaxuserinfo&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>",
       // dataType:"json",
        data:data,
