...
<div class="clr"></div>
<ul id="tags">
  <li><a href="<?php echo U('Apirank/add',array('token'=>$token));?>">添加等级</a> </li>
</ul>
<div class="clr"></div>
</div>
<div class="cLine">
...
<th width="120" style="text-align:center">等级名称</th>
<th width="120" style="text-align:center">等级积分</th>
<th width="100" style="text-align:center">操作</th>
</tr>
</THEAD>
<TBODY>
<TR></TR>
<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><TR>
<TD style="text-align:center"><?php echo ($item["id"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["rankname"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["intergal"]); ?></TD>
<TD style="text-align:center"> <a href=<?php U('Apirank/edit');?>"?g=User&m=Apirank&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
  ...
  if(confirm("确定删除这个记录？"))
    {
        ...
        $.ajax({
        type:"post",
        url:<?php U('Apirank/ajaxrank');?>"?g=User&m=Apirank&a=ajaxrank&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>",
       // dataType:"json",
        data:data,
