...
<div class="content"> 
    ...
    <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;">
        <span>温馨提示：请按要求操作</span>
    </div>

    <form method="post" action="" id="formID">
        <input type="hidden" name="id" id="cid" value="<?php echo ($item["id"]); ?>" />
...
<script>
    var init = function () {
        ...
        var latlngs = [
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>new qq.maps.LatLng(<?php echo ($vo["longitude"]); ?>, <?php echo ($vo["latitude"]); ?>),<?php endforeach; endif; else: echo "" ;endif; ?>
        ];
        var content = [
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>'<?php echo ($vo["title"]); ?>:<?php echo ($vo["addr"]); ?>',<?php endforeach; endif; else: echo "" ;endif; ?>
        ];
