                ...
                <tbody> 
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-3"> 
                                ...
                                <ul id="pimg_div">   
                                    <?php if($data['images']) {foreach ($data['images'] as $kd=>$vd){?>
                                    <li><img src="<?php echo $vd?>" style="max-height:100px;width:134px;  margin-bottom:0.5rem;margin-right:0.3rem;"/><div><a href="javascript:void(0);">删除</a><div></li>
                                                <?php }}?>
                                                </ul> 
                                <div style="clear:both;">
                                    ...
                                    <input type="hidden" class="form-control" id="pimg" name="img" value="<?php echo ($data["img"]); ?>">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr> 
                        ...
                        <td>
                            ...
                            <input type="text" name="title" id="title" value="<?php echo ($data["title"]); ?>" class="px" placeholder="请输入..." style="width:400px;" />
                        </td> 
                    </tr> 
                    ...
                    <tr> 
                        ...
                        <td>
                            <!-- <input type="hidden" name="pid" id="pid" value=""/> -->
                            <input type="text" name="tel" id="tel" value="<?php echo ($data["tel"]); ?>" class="px"  placeholder="请输入..." style="width:200px;" />
                        </td> 
                    </tr> 
                    ...
                    <tr> 
                        ...
                        <TD>
                            ...
                            <select style="width:200px;" class="fenlei" id="shoptype">
                                ...
                                <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option level="<?php echo ($vo['level']); ?>" <?php if($data['type'] == $vo['id'] ): ?>selected<?php endif; ?> value="<?php echo ($vo['id']); ?>"><?php echo ($vo['html']); echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </TD>
                    </tr>
                    <tr> 
                        <th>积分返还比例：</th> 
                        <td><input type="text" id="per" name="per" placeholder="请输入..." value="<?php echo ($data["per"]); ?>" class="px" style="width:100px;" />  %</td> 
                    </tr>
                    <tr> 
                        <th>排序：</th> 
                        <td><input type="text" id="score" name="score" placeholder="请输入..." value="<?php echo ($data["score"]); ?>" class="px" style="width:100px;" />  数字越小排再越前（大于等于0的整数）</td> 
                    </tr>
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">商家简介：</label></th>
                        <td><textarea name="summary" id="summary" rows="2"  style="border:1px solid #999;width:500px;height:100px"><?php echo ($data["summary"]); ?></textarea></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="address" name="address" value="<?php echo ($data["addr"]); ?>" class="px" style="width:200px;" /> <a href="javascript:void(0)" class="btnGray" onclick="searchSom(this)">搜索</a><br>
                        </td>
                    </tr>
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">商家经纬度：</label></th>
                        <td>
                            <input type="text" id="coordinate" name="coordinate" value="<?php echo ($data["position"]); ?>" class="px" style="width:200px;" readonly />
                        </td>
                    </tr>
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">商家区域：</label></th>
                        <td>
                            <input type="text" id="areas" name="areas" value="<?php echo ($data["area"]); ?>" class="px" style="width:200px;" readonly />
                        </td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    var geocoder, map, marker = null, markersArray = [],ue;
    var init = function () {
...
//                $("#position").val(result.detail.location);
    ...
    ue = UE.getEditor('container', {initialFrameWidth: 800, initialFrameHeight: 400});
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#save").click(function () {
            ...
            $.post('index.php?g=Api&m=Merchant&a=edit_merchant', data, function (response) {
