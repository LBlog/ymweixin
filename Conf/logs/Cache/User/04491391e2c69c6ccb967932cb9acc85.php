...
<div class="clr"></div>
<ul id="tags">
  <li><a href="<?php echo U('Apiacttype/add',array('token'=>$token));?>">添加活动类别</a> </li>
</ul>
<div class="clr"></div>
</div>
<div class="cLine">
...
<THEAD>
<tr>
<th width="120" style="text-align:center">活动类别编号</th>
<th width="120" style="text-align:center">活动类别名称</th>
<th width="120" style="text-align:center">创建时间</th>
<th width="100" style="text-align:center">操作</th>
</tr>
</THEAD>
<TBODY>
<TR></TR>
<?php if(is_array($act_type)): $i = 0; $__LIST__ = $act_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><TR>
...
<TD style="text-align:center"> <a href=<?php U('Apiacttype/edit');?>"?g=User&m=Apiacttype&a=edit&id=<?php echo ($item["id"]); ?>">编辑</a>
  ...
  if(confirm("确定删除这个记录？"))
    {
        ...
        $.ajax({
        type:"post",
        url:<?php U('Apiacttype/ajaxact_type');?>"?g=User&m=Apiacttype&a=ajaxact_type&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>",
       // dataType:"json",
        data:data,
