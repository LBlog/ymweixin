...
<div class="content"> 
    <div class="cLineB"> 
        <h4>增加兑换点</h4> 
        <a href="<?php echo U('Apiext/extlist',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
    </div>
        ...
        <div class="msgWrap bgfc"> 
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
                <tbody> 
                    <tr> 
                        <th>排序：</th> 
                        <td><input type="text" id="score" name="score" value="<?php echo ($set["score"]); ?>" class="px" style="width:50px;" />  数字越小排再越前（大于等于0的整数）</td> 
                    </tr>
                    <tr> 
                        <th width="100px"><span class="red">*</span>名称：</th> 
                        <td>
                    ...
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">详细页内容：</label></th>
                        <td  style="width:800px;height:600px"><script type="text/javascript" id="container"></script><?php echo ($set["intro"]); ?></td>
                    </tr>
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">兑换地址：</label></th>
                        <td>
                    ...
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">兑换点经纬度：</label></th>
                        <td>
                            <input type="text" id="coordinate" name="coordinate" value="" class="px" style="width:200px;" readonly />
                        </td>
                    </tr>
                    <tr>
                        <th valign="top"><span class="red">*</span><label for="info">所属区域：</label></th>
                        <td>
        ...
        $.post('index.php?g=User&m=Apiext&a=save_ext', data, function (response) {
            if (response.error_code == false) {
                art.dialog({
                    ...
                    ok: function () {
                        this.time(3);
                        location.href = "index.php?g=User&m=Apiext&a=extlist&token=<?php echo ($token); ?>";
                        return false;
                    },
                    cancelVal: '关闭'
                });
