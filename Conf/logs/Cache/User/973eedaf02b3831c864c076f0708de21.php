    ...
    <form method="post" action="" id="formID">
        <div class="msgWrap bgfc"> 
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
                <tbody>
                <input type="hidden" name="id" id="cid" value="<?php echo ($data["id"]); ?>" />
                <tr>
                    <th>商家图片：</th>
                    <td>
                        <div class="col-sm-3">
                            ...
                            <ul id="pimg_div">
                                <?php if($data['images']) {foreach ($data['images'] as $kd=>$vd){?><li><img src="<?php echo $vd?>" style="max-height:100px;width:134px;  margin-bottom:0.5rem;margin-right:0.3rem;"/><div><a href="javascript:void(0);">删除</a><div></li><?php }}?>
                            </ul>
                            <div style="clear:both;">
                                ...
                                <input type="hidden" class="form-control" id="pimg" name="value" value="<?php echo ($data['value']); ?>">
                            </div>
                        </div>
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#pimg_div a").live("click", function () {
            ...
            $.ajax({
                type: 'get',
                url: 'index.php?g=Api&m=Img&a=del_img&img=' + img + '&id=' + id + '&model=ahld_conf&token=<?php echo ($token); ?>',
                dataType: 'json',
                success: function (re) {
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#save").click(function () {
            ...
            $.post('index.php?g=User&m=Merchant&a=save_banner', data, function (response) {
                if (response.error_code == false) {
                    art.dialog({
                        title: '消息提示',
                        content: response.msg + '，2秒后将跳转！',
                        width: 200,
                        height: 100,
                        lock: true,
                        cancelVal: '关闭'
                    ...
                    setInterval(function () {
                        location.href = "index.php?g=User&m=Merchant&a=mlist&token=<?php echo ($token); ?>";
                    }, 2000);
                } else {
