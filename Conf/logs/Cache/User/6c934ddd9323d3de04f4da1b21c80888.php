...
afterBlur: function(){this.sync();}
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>编辑商家首页分类导航</h4>
    <a href="<?php echo U('MerchantType/mlist',array('token'=>$token));?>" class="right  btnGreen" style="margin-top:-27px">返回</a>
   </div> 
...
<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>" />
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tr>
          <th>排序：</th>
          <td><input type="text" id="sort" placeholder="请输入..." name="num" value="<?php echo ($data["num"]); ?>" class="px" style="width:50px;" />  数字越小排再越前（大于等于0的整数）</td>
      </tr>
      <tr>
          <th>分类名称：</th>
          <td><input type="text" style="width:100px;" placeholder="请输入..." id="name" name="name" value="<?php echo ($data["name"]); ?>" class="px" style="width:50px;" /></td>
      </tr>
       <tr>
          <th>分类级别：</th>
          <td><span id="level"><?php echo ($data["level"]); ?></span>级</td>
            <input type="hidden" value="<?php echo ($data["level"]); ?>" name="level"/>
      </tr>
	   
       <tr> 
        <th>icon图片：</th>
        <td><input type="text" name="share_pic" value="<?php echo ($data["img"]); ?>" class="px" id="pic" style="width:400px;" /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp;<a href="###" onclick="viewImg('pic')">预览</a></td>
       </tr>
       ...
       <th>&nbsp;</th>
       <td>
       <a id="save" class="btnGreen">保存</a> &nbsp; <a href="<?php echo U('MerchantType/mlist',array('token'=>$token));?>" class="btnGray vm">取消</a></td>
       </tr> 
      </tbody> 
     </table> 
     </div>
           ...
           if (response.error_code == 0) {
                art.dialog({
                 ...
                 setInterval(function(){
                     location.href="index.php?g=User&m=MerchantType&a=mlist&token=<?php echo ($token); ?>";
                },2000)
            } else {
                art.dialog({title:'消息提示', time:2, width:200, height:100, content:response.msg});
            }
