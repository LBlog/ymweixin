...
<div class="cLineB">
 ...
 <ul id="tags">
  <li><a href="<?php echo U('Apispread/add_spread',array('token'=>$token));?>">添加营销</a> </li>
...
关键词：
<input type="text" class="px" name="search" value="<?php echo ($search); ?>" style="height:25px;width:150px;" placeholder="营销名称">
...
<THEAD>
<tr>
<th><input type="checkbox" name="c_id" value="" class="checkall"/>&nbsp;全选/反选</th>
<th width="120" style="text-align:center">营销id</th>
...
<th width="120" style="text-align:center">内容</th>
<th width="120" style="text-align:center">积分</th>
<th width="120" style="text-align:center">二维码</th>
<th width="120" style="text-align:center">是否永久</th>
<th width="120" style="text-align:center">排序</th>
<th width="100" style="text-align:center">操作</th>
</tr>
</THEAD>
<TBODY>
<TR></TR>
<?php if(is_array($spread_list)): $i = 0; $__LIST__ = $spread_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><TR>
<TD><input type="checkbox" name="c_id[]" value="<?php echo ($item["id"]); ?>" class="checkitem"></TD>
...
<TD style="text-align:center"><?php echo ($item["summary"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["point"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["qrcode"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["is_perment_ch"]); ?></TD>
<TD style="text-align:center"><?php echo ($item["score"]); ?></TD>
<TD style="text-align:center"> <a href=<?php U('Apispread/edit');?>"?g=User&m=Apispread&a=edit&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">编辑</a>
  ...
  if(confirm("确定删除这个记录？"))
    {
        ...
        $.ajax({
        type:"post",
        url:<?php U('Apispread/ajaxspread');?>"?g=User&m=Apispread&a=ajaxspread&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>",
        dataType:"json",
        data:data,
