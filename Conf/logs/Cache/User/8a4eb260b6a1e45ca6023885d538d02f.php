...
<input type="hidden" name="id" value="<?php echo ($the_id); ?>" id="mb_id">
...
<td>
<span><?php echo ($the_user_info['wechaname']); ?></span>
</td>
<tr>
...
<td>
<img src="<?php echo ($the_user_info['portrait']); ?>" style="max-height:50px;"/>
</td>
<tr>
...
<td>
<span><?php echo ($the_user_info['wecha_id']); ?></span>
</td>
<tr>
...
<td>
<img src="<?php echo ($the_user_info['qcode']); ?>" style="max-height:50px;"/>
</td>
<tr>
...
<td>
<input type="text" class="px" name="truename" value="<?php echo ($the_user_info['truename']); ?>" placeholder="会员姓名"/>
</td>
<tr>
...
<td>
<input type="text" class="px" name="tel" value="<?php echo ($the_user_info['tel']); ?>" placeholder="联系电话"/>
</td>
<tr>
...
<td>
<select>
	<option <?php if($the_user_info['sex'] == 1): ?>selected<?php endif; ?>>男</option>
	<option <?php if($the_user_info['sex'] == 2): ?>selected<?php endif; ?>>女</option>
	<option <?php if($the_user_info['sex'] == 3): ?>selected<?php endif; ?>>其他</option>
</select>
</td>
<tr>
...
<td>
<select>
	<option <?php if($the_user_info['age_group'] == 1): ?>selected<?php endif; ?>>20岁以下</option>
	<option <?php if($the_user_info['age_group'] == 2): ?>selected<?php endif; ?>>20岁-30岁</option>
	<option <?php if($the_user_info['age_group'] == 3): ?>selected<?php endif; ?>>31岁-40岁</option>
	<option <?php if($the_user_info['age_group'] == 4): ?>selected<?php endif; ?>>41岁-50岁</option>
	<option <?php if($the_user_info['age_group'] == 5): ?>selected<?php endif; ?>>50岁以上</option>
</select>
</td>
<tr>
...
<input type="text" class="px" name="addr" value="<?php echo ($the_user_info['addr']); ?>" placeholder="详细地址"/>
</td>
<tr>
...
<td>
<input type="text" id="point" class="px" name="point" value="<?php echo ($the_user_info['point']); ?>" placeholder="会员积分"/> 
</td>
</tr>
