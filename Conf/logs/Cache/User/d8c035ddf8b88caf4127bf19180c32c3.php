...
<div class="clr"></div>
<!-- <ul id="tags">
  <li><a href="<?php echo U('Api/add_activity',array('token'=>$token));?>">添加活动</a> </li>
</ul>
<div class="clr"></div> -->
</div>
<div class="cLine">
...
<THEAD>
<tr>
<th width="120" style="text-align:center">编号</th>
<th width="120" style="text-align:center">活动名称</th>
<th width="120" style="text-align:center">活动图片</th>
<th width="120" style="text-align:center">参与人微信昵称</th>
...
<TBODY>
<TR></TR>
<?php if(is_array($actdetail)): $i = 0; $__LIST__ = $actdetail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><TR>
...
<TD style="text-align:center"><?php echo ($item["portrait"]); ?></TD>
<TD style="text-align:center"> <!-- <a href=<?php U('Api/edit_activity');?>"?g=User&m=Api&a=edit_activity&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">编辑</a> -->
  ...
  if(confirm("确定删除这个记录？"))
    {
        ...
        $.ajax({
        type:"post",
        url:<?php U('Api/ajaxactdetail');?>"?g=User&m=Api&a=ajaxactdetail&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>",
       // dataType:"json",
        data:data,
