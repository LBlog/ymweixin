...
<tr>
<th width="300">一级推客：</th>
<td>
<input type="text" class="px" name="t1" id="t1" placeholder="请输入正整数" value="<?php echo ($point['0']); ?>" onkeyup='this.value=this.value.replace(/^0|\D/gi,"")' />&nbsp %
</td>
<tr>

<tr>
<th width="300">二级推客：</th>
<td>
<input type="text" class="px" name="t2" id="t2" placeholder="请输入正整数" value="<?php echo ($point['1']); ?>" onkeyup='this.value=this.value.replace(/^0|\D/gi,"")' /> &nbsp%
</td>
<tr>

<tr>
<th width="300">三级推客：</th>
<td>
<input type="text" class="px" name="t3" id="t3" placeholder="请输入正整数" value="<?php echo ($point['2']); ?>" onkeyup='this.value=this.value.replace(/^0|\D/gi,"")' /> &nbsp%
</td>
<tr>

<tr>
<th>&nbsp;</th>
<td><button type="button" class="btnGreen" style="height: 30px;width:100px" id="save" >完成编辑</button>
</td>
</tr>
</tbody>
</table>
...
$(document).ready(function(){
	...
	$("#save").click(function(){
		...
		if(t1==null|| t1==''){
			alert('请填写一级推客所获积分百分比');
			return;
		}
		if(t2==null|| t2==''){
			alert('请填写二级推客所获积分百分比');
			return;
		}
		if(t3==null|| t3==''){
			alert('请填写三级推客所获积分百分比');
			return;
		}
	...
	$.post('index.php?g=User&m=Apipercent&a=edit_percent', data, function(response){
		if (response.error_code == false) {
			art.dialog({
			    ...
			    ok: function () {
			    	this.time(3);
			    	location.href="index.php?g=User&m=Apipercent&a=percentlist&token=<?php echo ($token); ?>";
			        return false;
			    },
			    cancelVal: '关闭'
			});
