...
<body>
    <div class="main">
        ...
        <ul class="det_list change_det">
            ...
            <li>
            	<a href="http://apis.map.qq.com/uri/v1/marker?marker=coord:<?php echo $ext['latitude'];?>,<?php echo $ext['longitude'];?>;title:<?php echo $ext['title'];?>;addr:<?php echo $ext['addr'];?>&referer=huanledui">
