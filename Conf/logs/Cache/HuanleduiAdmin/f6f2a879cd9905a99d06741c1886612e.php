...
<script>
    var init = function () {
        ...
        var latlngs = [
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>new qq.maps.LatLng(<?php echo ($vo["latitude"]); ?>, <?php echo ($vo["longitude"]); ?>),<?php endforeach; endif; else: echo "" ;endif; ?>
        ];
        var content = [
