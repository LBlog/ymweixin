...
<div class="content">
    ...
    <ul id="tags">
        ...
        <form id="myform" method="post" action='index.php?g=HuanleduiAdmin&m=Merchant&a=mlist&&token=<?php echo ($token); ?>' style="float:right">
            <input type="text" value="<?php echo I('search');?>" name="search" placeholder="请输入商家名称或电话" style="right:140px;display:inline-block;height:31px;width:200px;border-radius:2px; padding:2px 8px;line-height: 1.5em;font-size:14px;border:1px solid #EEEEEE;"/>
