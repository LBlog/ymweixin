        ...
        <div class="msgWrap bgfc"> 
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
                <tbody>
                    <tr> 
                        <th>二维码背景图片：</th>
                        <td><input type="hidden" name="token" value="<?php echo $_GET['token'];?>" class="px"/><input type="text" name="qrcode" value="<?php echo ($qrcode); ?>" class="px" id="pic" style="width:400px;" /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic', 700, 700, '<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp;<a href="###" onclick="viewImg('pic')">预览</a></td>
                    </tr>
                    <tr>         
                        <th>&nbsp;</th>
