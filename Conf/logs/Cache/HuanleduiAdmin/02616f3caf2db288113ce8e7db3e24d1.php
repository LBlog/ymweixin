...
<div class="content">
    ...
    <ul id="tags">
        ...
        <form id="myform" method="post" action='index.php?g=HuanleduiAdmin&m=MerchantType&a=mlist&&token=<?php echo ($token); ?>' style="float: right;">
            <input type="text" value="<?php echo I('post.name');?>" name="name" placeholder="请输入分类名称" style="display:inline-block;height:25px;width:200px;border-radius:2px; padding:2px 8px;line-height: 1.5em;font-size:14px;border:1px solid #EEEEEE;"/>
            <input type="submit" style="display:inline-block;height:31px;width:50px;border-radius:2px;color:#fff;padding:2px 8px;line-height:1.5em;background-color:#2F8BC9;font-size:14px;" value="搜索">
        </form>
        <div class="clr"></div>
    </ul> 
        ...
        <div class="bdrcontent">
            <div id="div_ptype">
                <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%" style="text-align:center">
                    ...
                    <?php if(is_array($dat)): $i = 0; $__LIST__ = $dat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><input type="checkbox" class="checkitem" value="<?php echo ($vo['id']); ?>" name="id[]"/></td>
                            <!--<td><?php echo ($vo['id']); ?></td>-->
                            <td><img src="<?php echo ($vo['img']); ?>" width="50px" height="50px"/></td>
                ...
                <script>
                    ...
                    function del(id) {
                        ...
                        art.dialog({
                            ...
                            okVal: '确定',
                            ok: function () {
                                location.href = "index.php?g=HuanleduiAdmin&m=MerchantType&a=del&id=" + id + "&token=<?php echo ($token); ?>";
                            },
                            cancelVal: '取消',
                            cancel: true
                        });
                    ...
                    function excel_out() {
                        ...
                        art.dialog({
                            ...
                            okVal: '确定',
                            ok: function () {
                                var link = "<?php echo U('HuanleduiAdmin/MerchantType/excel_out');?>";
                                link = link + data;
                                location.href = link;
                            },
                            cancelVal: '取消',
