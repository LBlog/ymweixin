                ...
                <TR>
                    ...
                    <TD>
                        <select name="is_perment" id="is_perment" >
                            ...
                            <option value="0"  <?php if(($item["is_perment"] == 0 )): ?>selected="selected"<?php endif; ?>  >临时二维码</option> 
                        </select>
                        <input type="text" id="time" class="px" value="<?php echo ($item["times"]); ?>" style="display:none;" placeholder="请输入1-30天" name="time">
                    </TD>
                </TR>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        <?php if(($item["is_perment"] == 1 )): ?>$('#time').hide();<?php endif; ?>
        <?php if(($item["is_perment"] == 0 )): ?>$('#time').show();<?php endif; ?>
        $("#save").click(function () {
            var title = $("#title").val();
            var id = $("#id").val();
            var point = $("#point").val();
