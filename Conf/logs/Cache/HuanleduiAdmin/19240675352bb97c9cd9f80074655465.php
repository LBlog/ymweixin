...
//                $("#position").val(result.detail.location);
    ...
    function addApiext() {
        ...
        $.post('index.php?g=HuanleduiAdmin&m=Apiext&a=save_ext', data, function (response) {
