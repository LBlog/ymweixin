...
<div class="content">
    ...
    <div id="tags">
        ...
        <form id="myform" method="post" action="<?php echo U('HuanleduiAdmin/Twitter/lookpoints', array( 'token' => $token));?>" style="float:right">
            <input type="text" value="<?php echo I('twitter_wechaname');?>" name="twitter_wechaname" placeholder="请输入积分来源" style="right:140px;display:inline-block;height:31px;width:200px;border-radius:2px; padding:2px 8px;line-height: 1.5em;font-size:14px;border:1px solid #EEEEEE;"/>
        ...
        <form method="post"  action="" id="info" >
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <?php if(is_array($dat)): $i = 0; $__LIST__ = $dat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><TR>
                        ...
                        <TD style="text-align:center"><?php echo ($item["member_wechaname"]); ?></TD>
                        <TD style="text-align:center"><?php echo ($item["points"]); ?></TD>
                        <TD style="text-align:center"><?php echo ($item["desc"]); ?></TD>
                        <TD style="text-align:center"><?php echo ($item["stage"]); ?></TD>
                        <TD style="text-align:center"><?php echo ($item["twitter_wechaname"]); ?></TD>
...
<script>
    ...
    function excel_out() {
        ...
        art.dialog({
            ...
            okVal: '确定',
            ok: function () {
                var link = "<?php echo U('Twitter/excel_out_lookpoints');?>";
                link = link + data;
                location.href = link;
            },
            cancelVal: '取消',
