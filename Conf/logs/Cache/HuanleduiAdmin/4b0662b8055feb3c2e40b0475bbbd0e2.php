    ...
    <form method="post" action="" id="formID">
        ...
        <div class="msgWrap bgfc"> 
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
                ...
                <ul id="pimg_div">
                    <li>
                        <img src="" style="max-height:100px;width:134px;  margin-bottom:0.5rem;margin-right:0.3rem;"/>
                    </li>
                </ul>
                <tr> 
                    <th width="100px">微信昵称：</th> 
                    <td><input type="text" id="wechaname" name="wechaname" value="<?php echo ($data["wechaname"]); ?>" class="px" style="width:200px;" /></td> 
                </tr>
                <tr> 
                    <th><span class="red">*</span>欢乐兑账号：</th> 
                    <td>
                        <input type="text" name="hld_username" id="hld_username" value="<?php echo ($data["hld_username"]); ?>" class="px" style="width:200px;" readonly/>
                    </td> 
                </tr> 
                ...
                <tr> 
                    ...
                    <td>
                        <input type="text" name="turename" id="turename" value="<?php echo ($data["truename"]); ?>" class="px" style="width:200px;" />
                    </td> 
                </tr> 
                <tr> 
                    <th><span class="red">*</span>手机号码：</th> 
                    <td>
                        <input type="text" name="tel" id="tel" value="<?php echo ($data["tel"]); ?>" class="px" style="width:200px;" />
                    </td> 
                </tr> 

                <tr>
                    <th><span class="red">*</span><label for="info">性别：</label></th>
                    <td>
                        <select style="width:200px;" class="fenlei" id="sex">
                            ...
                            <option value="2" <?php if($data['sex'] == 2 ): ?>selected<?php endif; ?>>未知</option>
                        </select>
                    </td>
                </tr>

                <tr>
                    <th><span class="red">*</span><label for="info">生日：</label></th>
                    <td>
                        <input class="laydate-icon" id="birthday" value="<?php echo ($data["birthday"]); ?>" style="width:200px; margin-right:10px;">
                    </td>
                </tr>
                <tr>         
                    <th>&nbsp;</th>
...
//            end.start = datas //将结束日的初始值设定为开始日
    ...
    function saveTwitter() {
        ...
        var data = {
            ...
            wechaname: wechaname,
            turename: turename,
            hld_username: hld_username,
            tel: tel,
            sex: sex,
            birthday: birthday,
            token: '<?php echo ($token); ?>',
        };
        $.post('index.php?g=HuanleduiAdmin&m=Twitter&a=edit', data, function (response) {
