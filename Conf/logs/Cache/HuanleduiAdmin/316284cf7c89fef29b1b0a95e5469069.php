        ...
        <div class="msgWrap bgfc"> 
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
                <tbody>
                    <tr>
                        <th>排序：</th>
                        <td><input type="text" id="sort" name="num" value="" placeholder="请输入..." class="px" style="width:50px;" />  数字越小排再越前（大于等于0的整数）</td>
                    </tr>
                    <tr>
                        <th>分类名称：</th>
                        <td><input type="text" style="width:100px;" placeholder="请输入..." id="name" name="name" value="" class="px" style="width:50px;" /></td>
                    </tr>
                    <tr>
                        <th>分类级别：</th>
                        <td><span id="level">1</span>级<input type="hidden" value="1" name="level"/><input type="hidden" value="<?php echo ($token); ?>" name="token"/></td>
                    </tr>
                    <tr> 
                        <th>icon图片：</th>
                        <td><input type="text" name="share_pic" value="" class="px" id="pic" style="width:400px;" /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic', 700, 700, '<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp;<a href="###" onclick="viewImg('pic')">预览</a></td>
                    </tr>
                    <TR>
...
<script>
    ...
    $("#save").live("click", function () {
        ...
        $.post('index.php?g=Api&m=Merchant&a=add_mtype', data, function (response) {
