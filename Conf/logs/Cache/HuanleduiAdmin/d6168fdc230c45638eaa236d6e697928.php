...
<div class="content">
    ...
    <div id="tags">
        ...
        <a href="<?php echo U('Apiext/add_ext',array('token'=>$token));?>" class="btnGreen">添加兑换站点</a>
        <a href="<?php echo U('Apiext/setext',array('token'=>$token));?>" class="btnGreen">兑换站点显示范围设置</a>
        <a href="javascript:void(0)" onclick="excel_out()" class="btnGreen">导出勾选或全部列表</a>
        <form id="myform" method="post" action='index.php?g=HuanleduiAdmin&m=Apiext&a=extlist&&token=<?php echo ($token); ?>' style="float:right">
            <input type="text" value="<?php echo I('search');?>" name="search" placeholder="请输入兑换站点名称或电话" style="right:140px;display:inline-block;height:31px;width:200px;border-radius:2px; padding:2px 8px;line-height: 1.5em;font-size:14px;border:1px solid #EEEEEE;"/>
        ...
        <form method="post"  action="" id="info" >
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <?php if(is_array($ext_list)): $i = 0; $__LIST__ = $ext_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><TR>
                        ...
                        <TD style="text-align:center"> <a href="/index.php?g=HuanleduiAdmin&m=Apiext&a=edit&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">编辑</a>
                            <a href="javascript:void(0)" onclick="del('<?php echo ($item["id"]); ?>')">删除</a></TD>
