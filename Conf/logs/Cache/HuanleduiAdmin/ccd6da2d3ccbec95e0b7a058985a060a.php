        ...
        <div class="msgWrap bgfc"> 
            <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
                <tbody>
                    ...
                    <tr>
                        <th>分类级别：</th>
                        <td><span id="level"><?php echo ($data["level"]); ?></span>级<input type="hidden" value="<?php echo ($data["level"]); ?>" name="level"/><input type="hidden" value="<?php echo ($token); ?>" name="token"/></td>
                    </tr>
