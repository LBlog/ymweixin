    ...
    <div class="wrapper">
        <div id="login-panel" class="panel" data-tab="normal">
            <div id="normal-panel" class="active-panel normal-panel">
                <form id="normal-login-form" action="<?php echo U('Store/register',array('token'=>$_GET['token'],'wecha_id'=>$_GET['wecha_id'], 'twid' => $twid, 'cid' => $cid));?>" autocomplete="off" method="post">
...
<p class="sub-action"><a href="<?php echo U('Store/login', array('token' => $token, 'wecha_id' => $wecha_id, 'twid' => $twid));?>">已有账号，现在登录</a> <!-- <a href="">找回密码</a> --></p>
